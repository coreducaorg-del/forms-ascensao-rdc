...
export default function BaseInternaAdminPage() {
  ...
  function handleLogin(e: React.FormEvent) {
    ...
    const valido = USUARIOS_VALIDOS.some(
    ...
    sessionStorage.setItem("auth_baseinterna", "true");
    router.push("/baseinterna/admin/dashboard");
  }
  ...
  return (
    <main className="min-h-screen bg-[#0a0a0a] flex items-center justify-center px-4">
      ...
      >
        <h1 className="text-xl font-bold text-white mb-6">Painel — Base Interna</h1>
